...
export default function GuidePage() {
  ...
  return (
    <div className="mx-auto w-full max-w-5xl space-y-6 sm:space-y-8 pb-12 overflow-x-hidden">
      {/* Hero Header */}
      <div className="relative overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-indigo-950/40 via-background to-violet-950/30 p-6 sm:p-8 backdrop-blur-sm">
        <div className="relative z-10 max-w-2xl space-y-3">
          ...
          <div className="flex flex-wrap gap-2.5 pt-2">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-primary px-4 py-2.5 text-xs sm:text-sm font-semibold text-primary-foreground shadow-md hover:bg-primary/90 transition active:scale-[0.98] min-h-[44px] touch-manipulation"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-xl border border-border bg-card px-4 py-2.5 text-xs sm:text-sm font-semibold text-foreground hover:bg-accent transition active:scale-[0.98] min-h-[44px] touch-manipulation"
            >
