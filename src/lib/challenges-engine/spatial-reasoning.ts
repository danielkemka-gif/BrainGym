...
export const SPATIAL_REASONING_CHALLENGES: CognitiveChallenge[] = [
  ...
  },
  {
    ...
    instruction: "Look at the capital letter 'E'.",
    question: "When reflected across a vertical mirror line on its right, what does 'E' look like?",
    options: [
      { id: "o1", label: "Ǝ (Reversed facing horizontal arms)", isCorrect: true },
      { id: "o2", label: "M (Rotated ninety degrees counter-clockwise)", isCorrect: false },
      { id: "o3", label: "W (Rotated ninety degrees clockwise)", isCorrect: false },
      { id: "o4", label: "E (Completely unchanged in original orientation)", isCorrect: false },
    ],
    educationalWhy: "Mirror-plane transformation exercises bilateral coordinate inversion in the visual cortex.",
    xpReward: 45,
    coinReward: 10,
  },
];
